...
- Skins. Pick from the dropdown: Beamer (the default dark cards), irssi (a black, monospace IRC log with a blue status bar), Light, or Phosphor (green CRT terminal). Your pick is remembered.
